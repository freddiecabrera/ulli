...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Hello = __webpack_require__(258);

	var _World = __webpack_require__(259);
	...
	var myRoutes = function myRoutes() {
	  return _react2.default.createElement(
	    _reactRouter.Route,
	    { path: '/', component: _Hello.HelloContainer },
	    _react2.default.createElement(_reactRouter.Route, { path: '/world', component: _World.WorldContainer })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = exports.store = redux.createStore(_reducers.reducer, _reducers.initialState, redux.compose((typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && typeof window.devToolsExtension !== 'undefined' ? window.devToolsExtension() : function (f) {
	  return f;
	}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addTextReducer = function addTextReducer(state, action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HelloContainer = exports.Hello = undefined;
	...
	var Hello = exports.Hello = _react2.default.createClass({
	  displayName: 'Hello',
	  textHasbeenSet: function textHasbeenSet(text) {
	    this.props.dispatch((0, _index.setText)(text));
	  },
	  render: function render() {
	    var _this = this;
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { onClick: function onClick() {
	                return _this.textHasbeenSet('World');
	              } },
	            'Next'
	          )
	        )
	...
	var HelloContainer = exports.HelloContainer = (0, _reactRedux.connect)(mapStateToProps)(Hello);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.WorldContainer = undefined;
	...
	var WorldContainer = exports.WorldContainer = (0, _reactRedux.connect)(mapStateToProps)(World);
